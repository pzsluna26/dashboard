  ...
  return (
    <div className="bg-gray-50 rounded-xl w-full min-h-screen flex flex-col items-center">
      ...
      <div className="rounded-xl border border-gray-200 shadow-sm mt-10 w-full max-w-5xl">
        <GraphCard title="중대재해처벌법" data={lawData.news} color={['#36b9cc']} />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 w-full max-w-5xl">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 왼쪽: 원형 그래프 */}
            <LawOpinionPie lawName="중대재해처벌법" />

            {/* 오른쪽: 워드 클라우드 */}
            <KeywordCloud keywords={['중대', '재해', '처벌', '법', '위험', '감시', '기업', '수집', '자율', '규제', '권리']} />
          </div>
        </div>
